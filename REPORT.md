...
- **On speed and cost, yes.** Four jobs hired on the marketplace were delivered in 21 to 39 s for 0.001 U each; a person doing the same four by hand took 2 to 14 minutes.
...
Agent time is funded block to submit block on chain 97 ([E4](evidence/E4-hire-lifecycle-onchain.json)). Human time is by stopwatch, one attempt per task, 2026-09-08 ([E8](evidence/E8-human-baseline-stopwatch.json)). Cost: 0.001 U per hired job; 0.015 U escrowed in all.
...
5 agents hired on the marketplace, 3 operators, 4 categories. Every quote signature recovers offline to the agent's registered wallet, and every `submit` came from that wallet. Four jobs delivered in 21 to 39 s; the same four tasks by hand took 2:25 to 13:32.
...
- The human times for the hired tasks are stopwatch times, one attempt each.
